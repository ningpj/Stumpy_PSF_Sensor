...
- Straighten the end of the PTFE tube you plan to use between the MMU and “Stumpy” PSF sensor. For the feeder, avoid using PTFE with an `ID = 3.0 mm`. It klinks easily especially if it needs to bend to accomodate the full range of gates / lanes which will jam the shuttle rather than moving freely for all selected gates.
