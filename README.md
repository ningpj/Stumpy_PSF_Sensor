...
For setups with a central PTFE entry port like mine, consider installing a PTFE guide as shown below to straighten the PTFE path and ensure the sensor shuttle moves freely no matter the gate selected [Makerworld: HamAndChris 90°, 180°, or 60° PTFE Bowden tube bend guide](https://makerworld.com/en/models/1033408-90deg-180deg-or-60deg-ptfe-bowden-tube-bend-guide#profileId-1016713).
